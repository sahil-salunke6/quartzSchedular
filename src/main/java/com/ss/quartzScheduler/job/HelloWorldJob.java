...
public class HelloWorldJob implements Job {
        ...
        try {
            ...
            if (retryCount <= MAX_RETRY_ATTEMPTS) {
                ...
                JobExecutionException jobException = new JobExecutionException(
                        "Job failed, scheduling retry", e, false);
                ...
                // Don't retry anymore
                JobExecutionException jobException = new JobExecutionException(
                        "Job failed after maximum retry attempts", e, false);
                throw jobException;
            }
        }
    }
    ...
    private void storeJobMetadata(JobExecutionContext context) {
        ...
        // Store scheduling time metadata
        ...
        logger.debug("Job metadata stored - Scheduled: {}, Actual: {}, Next: {}",
